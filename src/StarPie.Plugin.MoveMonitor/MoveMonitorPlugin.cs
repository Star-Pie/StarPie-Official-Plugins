...
/// <summary>
/// StarPie 随包动作包「窗口移到下一屏」。
/// <para>
/// 它认领一个顶层动作类型 <c>MoveMonitor</c> —— 认领声明在 csproj 的
...
/// 这个动作会把<b>其它程序的</b>窗口搬到另一块显示器上，<c>Ui</c> 与 <c>Process</c> 都名不副实。
/// </para>
/// </summary>
public sealed class MoveMonitorPlugin : IStarPiePlugin
{
