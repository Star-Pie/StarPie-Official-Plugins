...
/// StarPie 随包动作包「窗口置顶」。
/// <para>
/// 它认领一个顶层动作类型 <c>ToggleTopmost</c> —— 认领声明在 csproj 的
...
/// 这个动作会让<b>其它程序的</b>窗口被置顶，<c>Ui</c>（「打开自己的窗口」）与
/// <c>Process</c>（「启动程序」）都名不副实。
/// </para>
/// </summary>
public sealed class ToggleTopmostPlugin : IStarPiePlugin
{
